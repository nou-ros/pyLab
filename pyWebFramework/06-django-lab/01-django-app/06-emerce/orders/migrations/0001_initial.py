# Generated by Django 3.1 on 2021-06-07 04:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_lane_2', models.CharField(blank=True, max_length=100)),
                ('country', models.CharField(max_length=50)),
                ('state', models.CharField(max_length=50)),
                ('city', models.CharField(max_length=50)),
                ('order_note', models.CharField(blank=True, max_length=120)),
                ('tax', models.CharField(max_length=20)),
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Acceptd'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled')], default='New', max_length=10)),
